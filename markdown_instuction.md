...
![geek_brains](/mozg.png)

## Ссылки  
Чтобы создать ненумерованные списки, необходимо пункты выделить звёздочкой (*). Например, вот так:
* Элемент 1
* Элемент 2
* Элемент 3
...
## Цитаты  
Чтобы написать цитату, необходимо перед ней поставить галочку вправо ">".
